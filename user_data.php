                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?php
                                if ($row["foto"] != '') {
                                    if (file_exists('AllAssets/' . $row["foto"] . '')) {
                                ?>
                                        <img src="AllAssets/<?= $row["foto"] ?>" width="100">
                                <?php
                                    }
                                }
                                ?>
                                        ...
                                        <form method="post" action="" enctype="multipart/form-data">
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="username" placeholder="Tuliskan User" value="<?= $row["username"] ?>" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="floatingTextarea2">Password</label>
                                                    <textarea class="form-control" placeholder="Tuliskan Sandi User" name="password" required><?= $row["password"] ?></textarea>
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <label for="formGroupExampleInput3" class="form-label">Profil Lama</label>
                                                    <?php
                                                    if ($row["foto"] != '') {
                                                        if (file_exists('AllAssets/' . $row["foto"] . '')) {
                                                    ?>
                                                            <br><img src="AllAssets/<?= $row["foto"] ?>" width="100">
                                                    <?php
                                                        }
                                                    }
                                                    ?>
