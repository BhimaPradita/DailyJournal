        ...
        <?php
            ...
            <tr>
                ...
                <td>
                    <?php
                    if ($row["gambar"] != '') {
                        if (file_exists('AllAssets/' . $row["gambar"] . '')) {
                    ?>
                            <img src="AllAssets/<?= $row["gambar"] ?>" width="950">
                    <?php
                        }
                    }
                    ?>
                            ...
                            <form method="post" action="" enctype="multipart/form-data">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control" name="gambar"placeholder="Masukan gambar" value="<?= $row["gambar"] ?>" required>>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        if ($row["gambar"] != '') {
                                            if (file_exists('AllAssets/' . $row["gambar"] . '')) {
                                        ?>
                                                <br><img src="AllAssets/<?= $row["gambar"] ?>" width="100">
                                        <?php
                                            }
                                        }
                                        ?>
